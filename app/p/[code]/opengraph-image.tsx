...
export default async function Image({ params }: { params: Promise<{ code: string }> }) {
  ...
  const eyebrow = plan ? (plan.m === "date" ? "TONIGHT'S PLAN" : plan.stops.length > 1 ? "ROUND SAYS ONE OF THESE" : "ROUND SAYS") : "ROUND";
    ...
    (
      <div
        style={{
          ...
          padding: 64,
          background: "linear-gradient(160deg, #0b0c10 0%, #0f1a5c 140%)",
          color: "#f2f0ea",
          fontFamily: "Geist",
        }}
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
            <div style={{ width: 34, height: 34, borderRadius: 999, border: "5px solid #2b4dff" }} />
            <div style={{ fontFamily: "Instrument Serif", fontSize: 40, letterSpacing: 8 }}>ROUND</div>
          </div>
          <div style={{ fontSize: 22, letterSpacing: 4, color: "rgba(242,240,234,0.55)" }}>{eyebrow}</div>
        </div>
          ...
          {names.map((n, i) => (
            <div
              ...
              style={{
                ...
                lineHeight: 1.05,
                letterSpacing: -1,
                color: i === 0 ? "#f2f0ea" : "rgba(242,240,234,0.7)",
                display: "flex",
              }}
            >
              {n}
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ fontSize: 28, color: "rgba(242,240,234,0.7)" }}>{meta}</div>
          <div
            style={{
              display: "flex",
              alignItems: "center",
