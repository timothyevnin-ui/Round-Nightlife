...
| **Spots** | the fourth tab, `/spots` | **The map comes first (V24).** Every place ROUND stands behind as a pin (bars ink, restaurants amber, want-to-go tomato, been dark), **Search our spots** and **+ Add a spot** on top, Bars / Restaurants, a **Map / List** switch. Tap a pin and its card slides up: photo, take, score, "Open till 2am", the walk from you, and Want to go, Been, Rate, **Disagree**. The **locate button** asks for your location once; then you're the blue dot, the map opens on you every time, and the list gets **Closest first** with "4 min walk" on each row. The list keeps the take and the score up front, a neighborhood chip, best first or A to Z, forty at a time. Pins shrink when the whole city is in frame and grow as you zoom in. |
