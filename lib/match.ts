...
const GENERIC = new Set(["village", "house", "hotel", "garden", "street", "kitchen", "brooklyn", "place", "corner", "avenue", "north", "south", "little", "grand", "royal", "social", "public", "dinner", "drinks", "night", "spirits", "wines", "beers", "burger", "pizza", "taqueria", "grill", "market", "table", "eleven", "first", "second", "third", "williamsburg", "greenpoint", "chelsea", "tribeca", "soho", "nolita", "manhattan", "murray", "hill", "kips", "bay", "gramercy", "nomad", "lexington", "bleecker", "bowery", "bedford", "broadway", "rooftop", "tavern", "lounge", "cafe", "club", "saloon", "cantina", "bistro", "brasserie", "oyster", "wine", "cocktail", "beer", "coffee", "restaurant"]);
