...
const GENERIC = new Set(["village", "house", "hotel", "garden", "street", "kitchen", "brooklyn", "place", "corner", "avenue", "north", "south", "little", "grand", "royal", "social", "public", "dinner", "drinks", "night", "spirits", "wines", "beers", "burger", "pizza", "taqueria", "grill", "market", "table", "eleven", "first", "second", "third"]);
